...
{
    public class ClienteDistribucion
    {
        #region Atributos
        private int id;
        ...
        {
            get { return correoTrabajo; }
            set { correoTrabajo = value; }
        }
        ...
        {
            get { return recibirNotificaciones; }
            set { recibirNotificaciones = value; }
        }
        ...
        public ClienteDistribucion(int id, string nombre, string apellidos, string direccion, string telefono, string celular, string celular2, string ci, string ciCi, string correo, string ocupacion, string lugarTrabajo, string telefonoTrabajo, string correoTrabajo, DateTime fechaNacimiento, string genero, string estadoCivil, bool tieneHijos, int numeroHijos, DateTime fechaIngreso, int numeroCliente, bool recibirNotificaciones, int empresaId, string usuarioId, DateTime fecha, string estado, int distribucion, DateTime fechaInicio)
        {
            this.id = id;
            this.nombre = nombre;
