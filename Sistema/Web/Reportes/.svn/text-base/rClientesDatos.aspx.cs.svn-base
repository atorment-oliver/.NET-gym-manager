...
public partial class Reportes_rClientesDatos : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!AppSecurity.HasAccess("ReporteClientesActivos"))
        {
            TextLogs.WriteDebug("El usuario " + User.Identity.Name + " intentó acceder al reporte de Clientes Activos");
    ...
    private void CargarReporte()
    {
        ...
        DataTable datos = RN.Componentes.CCliente.TraerXFiltro2(hdnAutoCompleteClienteId.Value, Convert.ToDateTime(txtFechaInicio.Text), Convert.ToDateTime(txtFechaFin.Text), ddlEmpresa.SelectedValue.ToString(), ddlGrupo.SelectedValue.ToString(), /*ddlFormaPago.SelectedValue.ToString()*/ string.Empty, ddlPaquete.SelectedValue.ToString(), ddlDisciplina.SelectedValue.ToString(), ddlPromociones.SelectedValue.ToString(), "", ddlEstadoNRI.SelectedValue.ToString(), ddlEstadoPago.SelectedValue.ToString());
        ...
        //rvClientes.LocalReport.SetParameters(new ReportParameter("FechaInicio", txtFechaInicio.Text, true));
