...
public partial class Reportes_rClientesActivos : System.Web.UI.Page
{
    ...
    private void CargarReporte()
    {
        ...
        DataTable datos = RN.Componentes.CCliente.TraerXFiltro(hdnAutoCompleteClienteId.Value, Convert.ToDateTime(txtFechaInicio.Text), Convert.ToDateTime(txtFechaFin.Text), ddlEmpresa.SelectedValue.ToString(), ddlGrupo.SelectedValue.ToString(), /*ddlFormaPago.SelectedValue.ToString()*/ string.Empty, ddlPaquete.SelectedValue.ToString(), ddlDisciplina.SelectedValue.ToString(), ddlPromociones.SelectedValue.ToString(), ddlEstadoCliente.SelectedValue.ToString(), ddlEstadoNRI.SelectedValue.ToString(), "");
