<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Cliente.master" CodeFile="rPagoEmpresaGeneral.aspx.cs" Inherits="Reportes_rPagoEmpresaGeneral" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#<%=txtSearchCI.ClientID%>").autocomplete('../Handlers/EmpresaCliente.ashx').result(function (event, data, formatted) {
            if (data) {
