<%@ Page Language="C#" MasterPageFile="~/Cliente.master" AutoEventWireup="true" CodeFile="rClientes.aspx.cs" Inherits="Reportes_rClientes" %>
    ...
    <fieldset class="search">
            <table border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="ddlEstadoPago" Visible="false">
                ...
                <tr runat="server" visible="false">                    
                    ...
                    <td align="right">&nbsp;</td>
                    <td>
                        <asp:TextBox ID="txtFechaFin"  Width="90" runat="server" CssClass="textEntry" 
