<%@ Page Title="" Language="C#" MasterPageFile="~/Cliente.master"  AutoEventWireup="true" CodeFile="rClientesActivos.aspx.cs" Inherits="Reportes_rClientesActivos" %>
    ...
    <fieldset class="search">
            <table border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                    <asp:DropDownList runat="server" ID="ddlEstadoCliente" AppendDataBoundItems="true">
