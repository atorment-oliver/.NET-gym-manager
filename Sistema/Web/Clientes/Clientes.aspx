<%@ Page Title="" Language="C#" MasterPageFile="~/Cliente.master" AutoEventWireup="true" CodeFile="Clientes.aspx.cs" Inherits="Clientes_Clientes" %>
        ...
        <td style="vertical-align:top" rowspan="2">
            <br />
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:Button class="ui-button ui-widget ui-state-default ui-corner-all" runat="server" ID="btnExtender" style="width:100px;white-space:normal" 
                                Text="Extender Paquete" onclick="btnExtender_Click" />
                        </td>
                    </tr>  
                    <tr>
                        <td>
                            <asp:Button class="ui-button ui-widget ui-state-default ui-corner-all" runat="server" ID="btnLicencia" style="width:100px"
                                Text="Licencias" onclick="btnLicencia_Click"  />
                        </td>
                    </tr> 
                    <tr>
                        <td>
                            <asp:Button class="ui-button ui-widget ui-state-default ui-corner-all" 
                                runat="server" ID="btnPromocion" style="width:100px; top: 0px; left: 0px;"
                                Text="Promoci&oacute;n" onclick="btnPromocion_Click" />
                        </td>
                    </tr>   
                    <tr>
                        <td>
                            <asp:Button class="ui-button ui-widget ui-state-default ui-corner-all" 
                                runat="server" ID="btnPago" style="width:100px; top: 0px; left: 0px;"
                                Text="Pago" onclick="btnPago_Click"  />
                        </td>
                    </tr>  
                    <tr>
                        <td>
                            <asp:Button class="ui-button ui-widget ui-state-default ui-corner-all" 
                                runat="server" ID="btnImprimirRecibo" style="width:100px; top: 0px; left: 0px;"
                                Text="Recibo" onclick="btnImprimirRecibo_Click" />
                        </td>
                    </tr>                
                </table>
        ...
        <asp:UpdatePanel ID="UpdatePanel4" UpdateMode="Always" ChildrenAsTriggers="true" runat="server">
            <ContentTemplate>  
                ...
                <table border="0" cellpadding="2" cellspacing="0" class="nonBorder">
                    ...
                    <tr>
                        <td><asp:Literal ID="Literal5" runat="server">N&uacute;mero factura:</asp:Literal></td>
                        <td>                                        
